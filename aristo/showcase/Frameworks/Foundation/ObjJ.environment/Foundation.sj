...
,["int","id","CPString"])]);
}p;13;CPArray+KVO.jt;21034;@STATIC;1.0;i;9;CPArray.ji;8;CPNull.ji;27;_CPCollectionKVCOperators.jt;20957;objj_executeFile("CPArray.j", YES);
...
,["void","id"]), new objj_method(sel_getUid("removeObjectsInArray:"), function $_CPKVCArray__removeObjectsInArray_(self, _cmd, theObjects)
{
    ...
    else if (self._remove)
    {
        ...
        while (index--)
            self._remove(self._proxyObject, self._removeSEL, objj_msgSend(self, "indexOfObject:", objj_msgSend(theObjects, "objectAtIndex:", index)));
    }
    else
    {
        var target = objj_msgSend(objj_msgSend(self, "_representedObject"), "copy");
...
}p;20;CPAttributedString.jt;21042;@STATIC;1.0;i;9;CPArray.ji;14;CPDictionary.ji;13;CPException.ji;10;CPObject.ji;9;CPRange.ji;10;CPString.jt;20929;objj_executeFile("CPArray.j", YES);
...
,["CPBundle"])]);
}p;16;CPCharacterSet.jt;36852;@STATIC;1.0;i;9;CPArray.ji;13;CPException.ji;10;CPObject.ji;10;CPString.ji;7;CPURL.jt;36760;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPException.j", YES);
objj_executeFile("CPObject.j", YES);
objj_executeFile("CPString.j", YES);
...
8239,1,
8287,1
];p;9;CPCoder.jt;2664;@STATIC;1.0;i;13;CPException.ji;10;CPObject.jt;2612;objj_executeFile("CPException.j", YES);
objj_executeFile("CPObject.j", YES);
...
Date.prototype.isa = CPDate;p;17;CPDateFormatter.jt;3888;@STATIC;1.0;i;8;CPDate.ji;10;CPString.ji;13;CPFormatter.jt;3824;objj_executeFile("CPDate.j", YES);
objj_executeFile("CPString.j", YES);
...
,["void","CPCoder"])]);
}p;14;CPDictionary.jt;16001;@STATIC;1.0;i;9;CPArray.ji;14;CPEnumerator.ji;13;CPException.ji;8;CPNull.ji;10;CPObject.jt;15904;objj_executeFile("CPArray.j", YES);
...
,["CPArray"])]);
}p;13;CPException.jt;6065;@STATIC;1.0;i;9;CPCoder.ji;10;CPObject.ji;10;CPString.jt;6003;objj_executeFile("CPCoder.j", YES);
objj_executeFile("CPObject.j", YES);
objj_executeFile("CPString.j", YES);
...
,["id","JSObject"])]);
}p;12;CPGeometry.jt;1657;@STATIC;1.0;i;13;_CGGeometry.jt;1620;objj_executeFile("_CGGeometry.j", YES);
       
CPMinXEdge = 0;
CPMinYEdge = 1;
CPMaxXEdge = 2;
...
,["void","CPCoder"])]);
}p;12;CPIndexSet.jt;29250;@STATIC;1.0;i;9;CPArray.ji;10;CPObject.ji;9;CPRange.jt;29189;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPObject.j", YES);
objj_executeFile("CPRange.j", YES);
...
}p;17;CPKeyedArchiver.jt;16764;@STATIC;1.0;i;9;CPArray.ji;9;CPCoder.ji;8;CPData.ji;14;CPDictionary.ji;10;CPNumber.ji;10;CPString.ji;9;CPValue.jt;16644;objj_executeFile("CPArray.j", YES);
...
{
    if (self._delegate && self._delegateSelectors & _CPKeyedArchiverWillFinishSelector)
    ...
    if (self._delegate && self._delegateSelectors & _CPKeyedArchiverDidFinishSelector)
...
{
    objj_msgSend(self._plistObject, "setObject:forKey:", _CPKeyedArchiverEncodeObject(self, CPStringFromPoint(aPoint), NO), aKey);
}
...
{
    objj_msgSend(self._plistObject, "setObject:forKey:", _CPKeyedArchiverEncodeObject(self, CPStringFromRect(aRect), NO), aKey);
}
...
{
    objj_msgSend(self._plistObject, "setObject:forKey:", _CPKeyedArchiverEncodeObject(self, CPStringFromSize(aSize), NO), aKey);
}
...
,["void","CPString","Class"]), new objj_method(sel_getUid("classNameForClass:"), function $CPKeyedArchiver__classNameForClass_(self, _cmd, aClass)
{
    if (!self._replacementClassNames)
        return aClass.name;
    var className = objj_msgSend(self._replacementClassNames, "objectForKey:", CPStringFromClass(aClassName));
...
};p;19;CPKeyedUnarchiver.jt;14921;@STATIC;1.0;i;9;CPArray.ji;9;CPCoder.ji;8;CPData.ji;14;CPDictionary.ji;13;CPException.ji;17;CPKeyedArchiver.ji;8;CPNull.ji;10;CPNumber.ji;10;CPString.jt;14762;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPCoder.j", YES);
objj_executeFile("CPData.j", YES);
objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPException.j", YES);
...
,["id"]), new objj_method(sel_getUid("setDelegate:"), function $CPKeyedUnarchiver__setDelegate_(self, _cmd, aDelegate)
{
    ...
    if (objj_msgSend(self._delegate, "respondsToSelector:", sel_getUid("unarchiverWillFinish:")))
        self._delegateSelectors |= _CPKeyedUnarchiverWilFinishSelector;
...
objj_executeFile("CPKeyValueObserving.j", YES);p;21;CPKeyValueObserving.jt;47339;@STATIC;1.0;i;9;CPArray.ji;14;CPDictionary.ji;13;CPException.ji;8;CPNull.ji;10;CPObject.ji;7;CPSet.ji;13;CPArray+KVO.ji;11;CPSet+KVO.jt;47197;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPException.j", YES);
objj_executeFile("CPNull.j", YES);
objj_executeFile("CPObject.j", YES);
...
}p;22;CPNotificationCenter.jt;10308;@STATIC;1.0;i;9;CPArray.ji;14;CPDictionary.ji;13;CPException.ji;16;CPNotification.ji;8;CPNull.jt;10205;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPException.j", YES);
objj_executeFile("CPNotification.j", YES);
objj_executeFile("CPNull.j", YES);
...
objj_msgSend(CPNumber, "initialize");p;19;CPNumberFormatter.jt;13306;@STATIC;1.0;i;10;CPString.ji;13;CPFormatter.ji;17;CPDecimalNumber.jt;13231;objj_executeFile("CPString.j", YES);
objj_executeFile("CPFormatter.j", YES);
...
,["void","CPCoder"])]);
}p;10;CPObject.jt;9679;@STATIC;1.0;t;9660;{var the_class = objj_allocateClassPair(Nil, "CPObject"),
...
CPNotFound = -1;p;13;CPOperation.jt;5995;@STATIC;1.0;i;9;CPArray.ji;10;CPObject.jt;5948;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPObject.j", YES);
...
,["void"])]);
}p;18;CPOperationQueue.jt;8007;@STATIC;1.0;i;9;CPArray.ji;21;CPFunctionOperation.ji;23;CPInvocationOperation.ji;10;CPObject.ji;13;CPOperation.ji;10;CPString.ji;9;CPTimer.jt;7860;objj_executeFile("CPArray.j", YES);
...
}p;9;CPProxy.jt;4966;@STATIC;1.0;i;13;CPException.ji;14;CPInvocation.ji;10;CPObject.ji;10;CPString.jt;4880;objj_executeFile("CPException.j", YES);
...
,["id","CPString"])]);
}p;11;CPSet+KVO.jt;15640;@STATIC;1.0;i;13;CPException.ji;10;CPObject.ji;14;CPMutableSet.ji;27;_CPCollectionKVCOperators.jt;15536;objj_executeFile("CPException.j", YES);
objj_executeFile("CPObject.j", YES);
...
,["void","id","CPString"])]);
}p;18;CPSortDescriptor.jt;4703;@STATIC;1.0;i;10;CPObject.ji;15;CPObjJRuntime.ji;10;CPString.jt;4634;objj_executeFile("CPObject.j", YES);
objj_executeFile("CPObjJRuntime.j", YES);
objj_executeFile("CPString.j", YES);
...
,["void","CPCoder"])]);
}p;10;CPString.jt;20240;@STATIC;1.0;i;13;CPException.ji;10;CPObject.ji;15;CPObjJRuntime.ji;9;CPRange.ji;18;CPSortDescriptor.ji;7;CPURL.ji;9;CPValue.jt;20107;objj_executeFile("CPException.j", YES);
objj_executeFile("CPObject.j", YES);
objj_executeFile("CPObjJRuntime.j", YES);
objj_executeFile("CPRange.j", YES);
objj_executeFile("CPSortDescriptor.j", YES);
...
}p;15;CPUndoManager.jt;25500;@STATIC;1.0;i;9;CPArray.ji;13;CPException.ji;14;CPInvocation.ji;22;CPNotificationCenter.ji;10;CPObject.ji;9;CPProxy.ji;21;CPKeyValueObserving.ji;11;CPRunLoop.jt;25333;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPException.j", YES);
objj_executeFile("CPInvocation.j", YES);
objj_executeFile("CPNotificationCenter.j", YES);
objj_executeFile("CPObject.j", YES);
...
}p;16;CPUserDefaults.jt;19525;@STATIC;1.0;i;10;CPBundle.ji;8;CPData.ji;14;CPDictionary.ji;13;CPException.ji;17;CPKeyedArchiver.ji;19;CPKeyedUnarchiver.ji;22;CPNotificationCenter.ji;10;CPObject.ji;11;CPRunLoop.ji;10;CPString.ji;7;CPURL.ji;17;CPURLConnection.ji;14;CPURLRequest.jt;19270;objj_executeFile("CPBundle.j", YES);
objj_executeFile("CPData.j", YES);
objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPException.j", YES);
objj_executeFile("CPKeyedArchiver.j", YES);
...
}p;20;CPValueTransformer.jt;6940;@STATIC;1.0;i;8;CPData.ji;14;CPDictionary.ji;13;CPException.ji;17;CPKeyedArchiver.ji;19;CPKeyedUnarchiver.ji;10;CPNumber.ji;10;CPObject.jt;6796;objj_executeFile("CPData.j", YES);
objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPException.j", YES);
objj_executeFile("CPKeyedArchiver.j", YES);
objj_executeFile("CPKeyedUnarchiver.j", YES);
...
objj_executeFile("CPValue.j", YES);
objj_executeFile("CPValueTransformer.j", YES);p;10;_CPArray.jt;25142;@STATIC;1.0;i;14;CPEnumerator.ji;13;CPException.ji;10;CPObject.ji;9;CPRange.ji;18;CPSortDescriptor.jt;25034;objj_executeFile("CPEnumerator.j", YES);
objj_executeFile("CPException.j", YES);
objj_executeFile("CPObject.j", YES);
objj_executeFile("CPRange.j", YES);
objj_executeFile("CPSortDescriptor.j", YES);
...
objj_executeFile("_CPJavaScriptArray.j", YES);p;16;CPMutableArray.jt;13534;@STATIC;1.0;i;10;_CPArray.jt;13499;
...
}p;24;_CPAggregateExpression.jt;3708;@STATIC;1.0;i;9;CPArray.ji;14;CPExpression.ji;10;CPString.jt;3642;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPExpression.j", YES);
objj_executeFile("CPString.j", YES);
...
,["void","CPCoder"])]);
}p;28;_CPConstantValueExpression.jt;2540;@STATIC;1.0;i;14;CPDictionary.ji;14;CPExpression.jt;2483;objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPExpression.j", YES);
...
}p;23;_CPFunctionExpression.jt;11236;@STATIC;1.0;i;9;CPArray.ji;8;CPDate.ji;14;CPDictionary.ji;13;CPException.ji;14;CPExpression.ji;10;CPString.jt;11120;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPDate.j", YES);
objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPException.j", YES);
objj_executeFile("CPExpression.j", YES);
...
,["float","int"])]);
}p;22;_CPKeyPathExpression.jt;2836;@STATIC;1.0;i;14;CPExpression.ji;23;_CPFunctionExpression.ji;18;CPKeyValueCoding.ji;10;CPString.ji;28;_CPConstantValueExpression.jt;2699;objj_executeFile("CPExpression.j", YES);
...
,["CPString"])]);
}p;19;_CPSelfExpression.jt;1783;@STATIC;1.0;i;14;CPDictionary.ji;14;CPExpression.ji;10;CPString.jt;1711;objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPExpression.j", YES);
objj_executeFile("CPString.j", YES);
...
,["id"])]);
}p;18;_CPSetExpression.jt;5318;@STATIC;1.0;i;13;CPException.ji;14;CPExpression.ji;7;CPSet.jt;5251;objj_executeFile("CPException.j", YES);
objj_executeFile("CPExpression.j", YES);
objj_executeFile("CPSet.j", YES);
...
,["void","CPCoder"])]);
}p;23;_CPSubqueryExpression.jt;5843;@STATIC;1.0;i;9;CPArray.ji;14;CPDictionary.ji;14;CPExpression.ji;13;CPPredicate.jt;5755;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPExpression.j", YES);
objj_executeFile("CPPredicate.j", YES);
...
,["void","CPCoder"])]);
}p;23;_CPVariableExpression.jt;3328;@STATIC;1.0;i;14;CPDictionary.ji;13;CPException.ji;14;CPExpression.ji;10;CPString.jt;3238;objj_executeFile("CPDictionary.j", YES);
objj_executeFile("CPException.j", YES);
objj_executeFile("CPExpression.j", YES);
objj_executeFile("CPString.j", YES);
...
,["void","CPCoder"])]);
}p;23;CPComparisonPredicate.jt;20569;@STATIC;1.0;i;9;CPArray.ji;14;CPEnumerator.ji;14;CPExpression.ji;8;CPNull.ji;13;CPPredicate.ji;10;CPString.jt;20453;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPEnumerator.j", YES);
objj_executeFile("CPExpression.j", YES);
objj_executeFile("CPNull.j", YES);
objj_executeFile("CPPredicate.j", YES);
...
String.prototype.escapeForRegExp = function()
{
    ...
    return result;
};p;21;CPCompoundPredicate.jt;7851;@STATIC;1.0;i;9;CPArray.ji;13;CPPredicate.jt;7801;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPPredicate.j", YES);
...
,["void","CPCoder"])]);
}p;14;CPExpression.jt;695;@STATIC;1.0;i;15;_CPExpression.ji;28;_CPConstantValueExpression.ji;19;_CPSelfExpression.ji;23;_CPVariableExpression.ji;22;_CPKeyPathExpression.ji;23;_CPFunctionExpression.ji;24;_CPAggregateExpression.ji;18;_CPSetExpression.ji;23;_CPSubqueryExpression.jt;437;objj_executeFile("_CPExpression.j", YES);
objj_executeFile("_CPConstantValueExpression.j", YES);
...
objj_executeFile("_CPSubqueryExpression.j", YES);p;13;CPPredicate.jt;33447;@STATIC;1.0;i;9;CPArray.ji;13;CPException.ji;8;CPNull.ji;10;CPObject.ji;11;CPScanner.ji;7;CPSet.ji;9;CPValue.ji;16;CPCharacterSet.jt;33308;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPException.j", YES);
objj_executeFile("CPNull.j", YES);
objj_executeFile("CPObject.j", YES);
objj_executeFile("CPScanner.j", YES);
...
};p;23;_CPConcreteMutableSet.jt;3621;@STATIC;1.0;i;14;CPMutableSet.jt;3583;
...
,["Class"])]);
}p;8;_CPSet.jt;13095;@STATIC;1.0;i;9;CPArray.ji;14;CPEnumerator.ji;10;CPNumber.ji;10;CPObject.jt;13013;objj_executeFile("CPArray.j", YES);
objj_executeFile("CPEnumerator.j", YES);
objj_executeFile("CPNumber.j", YES);
objj_executeFile("CPObject.j", YES);
